...
data class BackupData(
    ...
    val favorites: List<com.exacomtv.domain.model.Favorite>? = null,
    val virtualGroups: List<com.exacomtv.domain.model.VirtualGroup>? = null,
...
interface BackupManager {
     ...
     */
    suspend fun exportConfig(uriString: String): com.exacomtv.domain.model.Result<Unit>

...
import com.exacomtv.domain.manager.ValidatedM3uProviderInput
import com.exacomtv.domain.manager.ValidatedStalkerProviderInput
import com.exacomtv.domain.manager.ValidatedXtreamProviderInput
            ...
            providerSetupInputValidator = FakeProviderSetupInputValidator(
                xtreamResult = Result.success(
                    ValidatedXtreamProviderInput(
                        ...
                        name = "Premium",
                        httpUserAgent = "ExacomTVTest/1.0",

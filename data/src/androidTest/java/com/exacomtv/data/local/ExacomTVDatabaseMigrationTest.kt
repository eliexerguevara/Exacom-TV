...
class ExacomTVDatabaseMigrationTest {

    private val testDbName = "exacomtv-migration-test"
    ...
    fun migrate1To42_fullChainValidatesLatestSchema() {
        migrationTestHelper.createDatabase("exacomtv-full-chain-test", 1).close()

        migrationTestHelper.runMigrationsAndValidate(
            "exacomtv-full-chain-test",
            42,
            true,
    ...
    fun migrate44To51_publicMasterUpgradeValidatesLatestSchema() {
        migrationTestHelper.createDatabase("exacomtv-public-master-44-51-test", 44).apply {
            execSQL(
                """
        ...
        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "exacomtv-public-master-44-51-test",
            52,
            true,
    ...
    fun migrate48To49_addsProviderHttpProfileColumns() {
        migrationTestHelper.createDatabase("exacomtv-48-49-test", 48).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate49To50_createsXtreamLiveOnboardingStateTable() {
        migrationTestHelper.createDatabase("exacomtv-49-50-test", 49).close()
    ...
    fun migrate50To51_addsXtreamLiveOnboardingProfileDiagnostics() {
        migrationTestHelper.createDatabase("exacomtv-50-51-test", 50).close()
    ...
    fun migrate51To52_addsXtreamLiveSyncMode() {
        migrationTestHelper.createDatabase("exacomtv-51-52-test", 51).close()
    ...
    fun migrate52To53_addsStalkerHardeningHydrationColumns() {
        migrationTestHelper.createDatabase("exacomtv-52-53-test", 52).close()
    ...
    fun migrate53To54_addsStalkerIdentityColumns() {
        migrationTestHelper.createDatabase("exacomtv-53-54-test", 53).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate40To41_addsAudioVideoOffsetColumn() {
        migrationTestHelper.createDatabase("exacomtv-40-41-test", 40).close()
    ...
    fun migrate41To42_createsPlaybackCompatibilityRecordsTable() {
        migrationTestHelper.createDatabase("exacomtv-41-42-test", 41).close()
    ...
    fun migrate42To43_addsProviderSeriesIdColumn() {
        migrationTestHelper.createDatabase("exacomtv-42-43-test", 42).close()
    ...
    fun migrate43To44_addsPagedVodHydrationColumns() {
        migrationTestHelper.createDatabase("exacomtv-43-44-test", 43).close()
    ...
    fun migrate38To39_addsStalkerProviderColumnsAndUniqueIndex() {
        migrationTestHelper.createDatabase("exacomtv-38-39-test", 38).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate32To33_backfillsMovieWatchCountAndAddsGlobalFavoritesIndex() {
        migrationTestHelper.createDatabase("exacomtv-32-33-test", 32).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate33To34_addsSuccessTimestampsAndProgramsEndTimeIndex() {
        migrationTestHelper.createDatabase("exacomtv-33-34-test", 33).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate44To45_dedupesGlobalFavoritesAndAddsNullSafeUniqueKey() {
        migrationTestHelper.createDatabase("exacomtv-44-45-test", 44).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate45To46_rebuildsSeriesStageWithProviderSeriesKey() {
        migrationTestHelper.createDatabase("exacomtv-45-46-test", 45).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate46To47_createsBrowseQueryIndexes() {
        migrationTestHelper.createDatabase("exacomtv-46-47-test", 46).close()
    ...
    fun migrate47To48_createsXtreamIndexBackfillsRowsAndMarksSummaryState() {
        migrationTestHelper.createDatabase("exacomtv-47-48-test", 47).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate34To35_createsSearchHistoryTable() {
        migrationTestHelper.createDatabase("exacomtv-34-35-test", 34).close()
    ...
    fun migrate31To32_scopesFavoritesAndSplitsMixedProviderGroups() {
        migrationTestHelper.createDatabase("exacomtv-31-32-test", 31).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate31To32_assignsLegacyGroupsWhenNoProviderIsActive() {
        migrationTestHelper.createDatabase("exacomtv-31-32-no-active-test", 31).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate35To36_addsProgramRemindersAndEpgMatchMetadata() {
        migrationTestHelper.createDatabase("exacomtv-35-36-test", 35).close()
    ...
    fun migrate36To37_createsTmdbIdentityTable() {
        migrationTestHelper.createDatabase("exacomtv-36-37-test", 36).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate14To15_addsAuditCompletionColumns() {
        migrationTestHelper.createDatabase("exacomtv-14-15-test", 14).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,

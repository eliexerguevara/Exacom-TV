...
import com.exacomtv.data.local.entity.FavoriteEntity
import com.exacomtv.data.local.entity.MovieBrowseEntity
import com.exacomtv.data.local.entity.MovieEntity
import com.exacomtv.data.local.entity.PlaybackHistoryLiteEntity
...
import com.exacomtv.data.remote.stalker.StalkerDeviceProfile
...
class MovieRepositoryImplTest {
    ...
    fun `stalker movie preview loads only first page`() = runTest {
        ...
        whenever(categoryDao.getByProviderAndType(7L, ContentType.MOVIE.name)).thenReturn(
            flowOf(listOf(com.exacomtv.data.local.entity.CategoryEntity(providerId = 7L, categoryId = 42L, name = "Action", type = ContentType.MOVIE)))
        )
        whenever(providerDao.getById(7L)).thenReturn(
            ProviderEntity(
                id = 7L,

...
import com.exacomtv.data.local.entity.EpisodeBrowseEntity
import com.exacomtv.data.local.entity.EpisodeEntity
import com.exacomtv.data.local.entity.SeriesEntity
import com.exacomtv.data.local.entity.SeriesBrowseEntity
...
import com.exacomtv.data.remote.dto.XtreamSeason
import com.exacomtv.data.remote.dto.XtreamSeriesInfoResponse
import com.exacomtv.data.remote.stalker.StalkerCategoryRecord
import com.exacomtv.data.remote.stalker.StalkerEpisodeRecord
...
import com.exacomtv.data.remote.stalker.StalkerSeasonRecord
import com.exacomtv.data.remote.stalker.StalkerSeriesDetails
...
import com.exacomtv.domain.model.LibraryBrowseQuery
import com.exacomtv.domain.model.LibraryFilterBy
...
class SeriesRepositoryImplTest {
    ...
    fun `stalker series preview loads only first page`() = runTest {
        ...
        whenever(categoryDao.getByProviderAndType(7L, ContentType.SERIES.name)).thenReturn(
            flowOf(listOf(com.exacomtv.data.local.entity.CategoryEntity(providerId = 7L, categoryId = 77L, name = "Drama", type = ContentType.SERIES)))
        )
        whenever(providerDao.getById(7L)).thenReturn(
            ProviderEntity(
                id = 7L,
    ...
    fun `getSeriesDetails falls back to remote series id lookup`() = runTest {
        ...
        assertThat(result).isInstanceOf(com.exacomtv.domain.model.Result.Success::class.java)
        val series = (result as com.exacomtv.domain.model.Result.Success).data

package com.exacomtv.data.mapper

import com.google.gson.Gson
import com.google.gson.reflect.TypeToken
import com.exacomtv.data.local.entity.*
import com.exacomtv.data.remote.stalker.StalkerPlaybackDescriptor
import com.exacomtv.data.remote.stalker.StalkerUrlFactory
import com.exacomtv.data.remote.xtream.XtreamStreamKind
import com.exacomtv.data.remote.xtream.XtreamUrlFactory
import com.exacomtv.domain.model.*
...
fun CategoryEntity.toDomain() = com.exacomtv.domain.model.Category(
    id = categoryId,
    roomId = id,
    name = name,
    parentId = parentId,
...
fun com.exacomtv.domain.model.Category.toEntity(providerId: Long) = CategoryEntity(
    categoryId = id,
    name = name,
    parentId = parentId,
    type = type,
...
fun SyncMetadataEntity.toDomain() = SyncMetadata(
    ...
    movieSyncMode = runCatching { com.exacomtv.domain.model.VodSyncMode.valueOf(movieSyncMode) }
        .getOrDefault(com.exacomtv.domain.model.VodSyncMode.UNKNOWN),
...
fun EpgSourceEntity.toDomain() = com.exacomtv.domain.model.EpgSource(
    id = id,
    name = name,
    url = url,
    enabled = enabled,
...
fun com.exacomtv.domain.model.EpgSource.toEntity() = EpgSourceEntity(
    id = id,
    name = name,
    url = url,
    enabled = enabled,
...
fun com.exacomtv.data.local.dao.ProviderEpgSourceWithDetails.toDomain() =
    com.exacomtv.domain.model.ProviderEpgSourceAssignment(
        id = id,
        providerId = providerId,
...
fun com.exacomtv.domain.model.ProviderEpgSourceAssignment.toEntity() = ProviderEpgSourceEntity(
    id = id,
    providerId = providerId,
    epgSourceId = epgSourceId,
    priority = priority,
...
fun EpgChannelEntity.toDomain() = com.exacomtv.domain.model.EpgChannelInfo(
    id = id,
    epgSourceId = epgSourceId,
...
fun ChannelEpgMappingEntity.toDomain() = com.exacomtv.domain.model.ChannelEpgMapping(
    id = id,
    providerChannelId = providerChannelId,
    providerId = providerId,
    sourceType = runCatching { com.exacomtv.domain.model.EpgSourceType.valueOf(sourceType) }
        .getOrDefault(com.exacomtv.domain.model.EpgSourceType.NONE),
    epgSourceId = epgSourceId,
    xmltvChannelId = xmltvChannelId,
    matchType = matchType?.let {
        runCatching { com.exacomtv.domain.model.EpgMatchType.valueOf(it) }.getOrNull()
    },
...
fun com.exacomtv.domain.model.ChannelEpgMapping.toEntity() = ChannelEpgMappingEntity(
    id = id,
    providerChannelId = providerChannelId,
    providerId = providerId,

...
import com.exacomtv.data.local.dao.CatalogSyncDao
import com.exacomtv.data.local.dao.CategoryDao
import com.exacomtv.data.local.dao.ChannelDao
import com.exacomtv.data.local.dao.MovieCategoryHydrationDao
import com.exacomtv.data.local.dao.MovieDao
import com.exacomtv.data.local.dao.ProgramDao
import com.exacomtv.data.local.dao.ProviderDao
import com.exacomtv.data.local.dao.SeriesCategoryHydrationDao
import com.exacomtv.data.local.dao.SeriesDao
import com.exacomtv.data.local.dao.TmdbIdentityDao
import com.exacomtv.data.local.dao.XtreamContentIndexDao
import com.exacomtv.data.local.dao.XtreamIndexJobDao
import com.exacomtv.data.local.dao.XtreamLiveOnboardingDao
import com.exacomtv.data.local.entity.CategoryEntity
import com.exacomtv.data.local.entity.ChannelEntity
import com.exacomtv.data.local.entity.ChannelGuideSyncEntity
import com.exacomtv.data.local.entity.MovieEntity
import com.exacomtv.data.local.entity.SeriesEntity
import com.exacomtv.data.local.entity.XtreamContentIndexEntity
import com.exacomtv.data.local.entity.XtreamIndexJobEntity
import com.exacomtv.data.local.entity.XtreamLiveOnboardingStateEntity
import com.exacomtv.data.mapper.toDomain
import com.exacomtv.data.mapper.toEntity
import com.exacomtv.data.parser.M3uParser
import com.exacomtv.data.remote.http.buildAppRequestProfile
import com.exacomtv.data.remote.http.toGenericRequestProfile
import com.exacomtv.data.remote.stalker.StalkerApiService
import com.exacomtv.data.remote.stalker.StalkerPlaybackMode
import com.exacomtv.data.remote.stalker.StalkerProvider
import com.exacomtv.data.remote.stalker.StalkerProviderProfile
import com.exacomtv.data.remote.stalker.StalkerTrafficCoordinator
import com.exacomtv.data.remote.dto.XtreamCategory
import com.exacomtv.data.remote.dto.XtreamSeriesItem
import com.exacomtv.data.remote.dto.XtreamStream
import com.exacomtv.data.remote.xtream.OkHttpXtreamApiService
import com.exacomtv.data.remote.xtream.XtreamAuthenticationException
import com.exacomtv.data.remote.xtream.XtreamNetworkException
import com.exacomtv.data.remote.xtream.XtreamParsingException
import com.exacomtv.data.remote.xtream.XtreamRequestException
import com.exacomtv.data.remote.xtream.XtreamResponseTooLargeException
import com.exacomtv.data.remote.xtream.XtreamApiService
import com.exacomtv.data.remote.xtream.XtreamProvider
import com.exacomtv.data.remote.xtream.XtreamUrlFactory
import com.exacomtv.data.security.CredentialCrypto
import com.exacomtv.data.util.AdultContentClassifier
import com.exacomtv.data.util.UrlSecurityPolicy
import com.exacomtv.domain.model.Channel
import com.exacomtv.domain.model.ContentType
import com.exacomtv.domain.model.Movie
...
import com.exacomtv.domain.model.Series
import com.exacomtv.domain.model.SyncMetadata
import com.exacomtv.domain.model.SyncState
import com.exacomtv.domain.model.VodSyncMode
import com.exacomtv.domain.repository.EpgRepository
import com.exacomtv.domain.repository.EpgSourceRepository
...
class SyncManager @Inject constructor(
    ...
    private val preferencesRepository: com.exacomtv.data.preferences.PreferencesRepository,
    ...
    ): com.exacomtv.domain.model.Result<Unit> {
        val providerEntity = providerDao.getById(providerId)
            ?: return com.exacomtv.domain.model.Result.error("Provider $providerId not found")
        ...
        return if (providerEntity.type == ProviderType.STALKER_PORTAL) {
            ...
            withProviderLock(providerId) {
                val freshProviderEntity = providerDao.getById(providerId)
                    ?: return@withProviderLock com.exacomtv.domain.model.Result.error("Provider $providerId not found")
    ...
    private suspend fun syncEpgLocked(
        providerEntity: com.exacomtv.data.local.entity.ProviderEntity,
        force: Boolean,
        ...
        if (!force && provider.type == ProviderType.STALKER_PORTAL && hasPendingStalkerCatalogIndex(provider.id)) {
            ...
            return com.exacomtv.domain.model.Result.success(Unit)
        }
        ...
        return try {
            ...
            com.exacomtv.domain.model.Result.success(Unit)
            ...
            com.exacomtv.domain.model.Result.error(safeMessage, e)
        }
    }
    ...
    ): com.exacomtv.domain.model.Result<Unit> = withProviderLock(providerId) lock@{
        try {
            val providerEntity = providerDao.getById(providerId)
                ?: return@lock com.exacomtv.domain.model.Result.error("Provider $providerId not found")
    ...
    suspend fun rebuildXtreamIndex(
        ...
        if (providerEntity.type != ProviderType.XTREAM_CODES) {
            return@lock com.exacomtv.domain.model.Result.error("Index rebuild is only available for Xtream providers")
        }
    ...
    private suspend fun syncXtreamIndexFirst(
        ...
        syncProgressBus.emit(
            com.exacomtv.domain.sync.SyncProgress(
                section = com.exacomtv.domain.sync.Section.VOD,
                current = 0,
                total = 0,
                currentLabel = "",
        ...
        syncProgressBus.emit(
            com.exacomtv.domain.sync.SyncProgress(
                section = com.exacomtv.domain.sync.Section.SERIES,
                current = 0,
                total = 0,
                currentLabel = "",
                itemsIndexed = liveCount
    ...
    suspend fun processQueuedXtreamIndexJobs(
        ...
        val providerEntity = providerDao.getById(providerId)
            ?: return@lock com.exacomtv.domain.model.Result.error("Provider $providerId not found")
        if (providerEntity.type != ProviderType.XTREAM_CODES) {
            return@lock com.exacomtv.domain.model.Result.success(Unit)
        }
        ...
        if (warnings.isNotEmpty()) {
            ...
            com.exacomtv.domain.model.Result.error(warnings.first(), exception)
        } else {
            com.exacomtv.domain.model.Result.success(Unit)
        }
    }
    ...
    private suspend fun processStalkerSummaryIndexSection(
        ...
        data class StalkerCategoryFetchResult(
            ...
            val result: Result<com.exacomtv.data.remote.stalker.StalkerPagedResult<out Any>>
        )
            ...
            when (val result = fetchStalkerWildcardSummaryPageWithRecovery(api, contentType, wildcardCategory.categoryId, nextPage)) {
                is Result.Success -> {
                    ...
                    val anomaly = detectStalkerPageAnomaly(
                        hydration = currentHydration,
                        requestedPage = nextPage,
                        pagedResult = com.exacomtv.data.remote.stalker.StalkerPagedResult(
                            items = visibleItems,
    ...
    private suspend fun markStalkerAttemptStarted(
        ...
        when (contentType) {
            ContentType.MOVIE -> movieCategoryHydrationDao.upsert(
                com.exacomtv.data.local.entity.MovieCategoryHydrationEntity(
                    providerId = providerId,
                    categoryId = categoryId,
            ...
            ContentType.SERIES -> seriesCategoryHydrationDao.upsert(
                com.exacomtv.data.local.entity.SeriesCategoryHydrationEntity(
                    providerId = providerId,
                    categoryId = categoryId,
                    lastHydratedAt = hydration?.lastHydratedAt ?: 0L,
                    itemCount = hydration?.itemCount ?: 0,
    ...
    private suspend fun fetchStalkerSummaryPageWithRecovery(
        ...
        categoryId: Long,
        page: Int
    ): Result<com.exacomtv.data.remote.stalker.StalkerPagedResult<out Any>> {
    ...
    private suspend fun fetchStalkerSummaryFirstPageFallback(
        ...
        contentType: ContentType,
        categoryId: Long
    ): Result<com.exacomtv.data.remote.stalker.StalkerPagedResult<out Any>> = when (contentType) {
        ContentType.MOVIE -> when (val result = api.getVodStreams(categoryId)) {
            is Result.Success -> Result.success(
                com.exacomtv.data.remote.stalker.StalkerPagedResult(
                    items = result.data,
                    page = 1,
                    totalPages = 1,
    ...
    private fun detectStalkerPageAnomaly(
        hydration: StalkerHydrationSnapshot?,
        requestedPage: Int,
        pagedResult: com.exacomtv.data.remote.stalker.StalkerPagedResult<out Any>,
        pageFingerprint: String?
    ): String? {
    ...
    private suspend fun syncStalker(
        ...
        if (force || ContentCachePolicy.shouldRefresh(metadata.lastMovieSuccess, ContentCachePolicy.CATALOG_TTL_MILLIS, now)) {
            ...
            val categories = when (val categoriesResult = api.getVodCategories()) {
                is com.exacomtv.domain.model.Result.Success -> categoriesResult.data
                is com.exacomtv.domain.model.Result.Error -> {
                ...
                is com.exacomtv.domain.model.Result.Loading -> throw IllegalStateException("Unexpected loading state")
            }
            emitCatalogSyncProgress(
                section = Section.VOD,
    ...
    private suspend fun syncStalkerPortalEpg(
        ...
        val insertBuffer = ArrayList<com.exacomtv.data.local.entity.ProgramEntity>(STALKER_GUIDE_PROGRAM_BATCH_SIZE)
        ...
        runCatching {
            ...
            api.streamBulkEpg(periodHours = 6) { program ->
                ...
                if (result is com.exacomtv.domain.model.Result.Error) {
        ...
        fallbackGuideRequests.forEachIndexed { index, request ->
            ...
            runCatching {
                ...
                if (streamResult is com.exacomtv.domain.model.Result.Error) {
    ...
    private suspend fun syncXtreamLiveCatalog(
        ...
        syncProgressBus.emit(
            com.exacomtv.domain.sync.SyncProgress(
                section = com.exacomtv.domain.sync.Section.LIVE,
                current = 0,
                total = 0,
                currentLabel = "",
                itemsIndexed = 0
    ...
    private suspend fun loadStalkerChannelsByCategory(
        api: StalkerProvider,
        categories: List<com.exacomtv.domain.model.Category>,
        onProgress: ((String) -> Unit)?
    ...
    private suspend fun syncStalkerLiveCatalogStaged(
        ...
        try {
            ...
            when (val streamResult = api.streamLiveStreams { channel ->
                ...
                is com.exacomtv.domain.model.Result.Success -> {
                    flushBatch()
    ...
    private suspend fun stalkerCatalogAccessDiagnostic(
        ...
        val profile = when (val profileResult = api.getAccountProfile()) {
            is com.exacomtv.domain.model.Result.Success -> profileResult.data
            else -> return null
        }
    ...
    private fun <T> requireResult(result: com.exacomtv.domain.model.Result<T>, fallbackMessage: String): T {
        return when (result) {
            is com.exacomtv.domain.model.Result.Success -> result.data
            is com.exacomtv.domain.model.Result.Error -> throw IllegalStateException(result.message.ifBlank { fallbackMessage }, result.exception)
            is com.exacomtv.domain.model.Result.Loading -> throw IllegalStateException("Unexpected loading state")
        }
    }

...
import com.exacomtv.domain.model.RemoteShortcutAction
...
internal fun encodeRemoteShortcutSelection(
    ...
    return when (normalized.mode) {
        com.exacomtv.domain.model.RemoteShortcutSelectionMode.PROFILE_DEFAULT -> null
        com.exacomtv.domain.model.RemoteShortcutSelectionMode.GLOBAL_DEFAULT -> REMOTE_SHORTCUT_USE_GLOBAL_SENTINEL
        com.exacomtv.domain.model.RemoteShortcutSelectionMode.ACTION -> normalized.action?.storageValue
    }
}

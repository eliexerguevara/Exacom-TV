...
class RecordingReconcileWorker(
    ...
    interface RecordingWorkerEntryPoint {
        fun recordingManager(): com.exacomtv.domain.manager.RecordingManager
    }
    ...
    override suspend fun doWork(): Result {
        ...
        return when (manager.reconcileRecordingState()) {
            is com.exacomtv.domain.model.Result.Success -> Result.success()
            is com.exacomtv.domain.model.Result.Error -> Result.retry()
            com.exacomtv.domain.model.Result.Loading -> Result.retry()
        }
    }

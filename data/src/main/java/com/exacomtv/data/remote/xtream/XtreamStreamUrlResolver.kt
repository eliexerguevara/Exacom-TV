...
import com.exacomtv.data.remote.stalker.StalkerPlaybackResolutionException
...
import com.exacomtv.data.remote.stalker.buildStalkerPlaybackDescriptor
...
class XtreamStreamUrlResolver @Inject constructor(
        ...
        return when (resolvedProvider.type) {
            ...
            ProviderType.STALKER_PORTAL -> {
                ...
                val playbackInfo = when (
                    ...
                    is com.exacomtv.domain.model.Result.Success -> resolvedResult.data
                    is com.exacomtv.domain.model.Result.Error -> throw StalkerPlaybackResolutionException(
    ...
    private suspend fun resolveDirectStalkerUrl(
        ...
        val descriptor = buildStalkerPlaybackDescriptor(
            ...
            capabilities = com.exacomtv.data.remote.stalker.StalkerPortalCapabilities()
        )
    ...
    private suspend fun persistStalkerPlaybackLearning(
        provider: ProviderEntity,
        playbackInfo: com.exacomtv.data.remote.stalker.StalkerPlaybackInfo
    ) {

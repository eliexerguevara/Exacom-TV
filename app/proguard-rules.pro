...
-keepclassmembers class com.exacomtv.data.remote.** { <fields>; }
...
-keep class com.exacomtv.domain.model.** { *; }
-keep class com.exacomtv.data.local.entity.** { *; }
-keep class com.exacomtv.data.remote.xtream.model.** { *; }

# ── Security / TLS ──────────────────────────────────────────
-keepnames class com.exacomtv.data.security.CredentialCrypto
-keepclassmembers class com.exacomtv.data.security.CredentialCrypto {
    <fields>;
    <methods>;
}

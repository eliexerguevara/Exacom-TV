...
import com.exacomtv.app.diagnostics.RuntimeDiagnosticsManager
import com.exacomtv.app.update.GitHubReleaseChecker
import com.exacomtv.app.ui.accessibility.isReducedMotionEnabled
...
import com.exacomtv.data.manager.recording.RecordingReconcileWorker
import com.exacomtv.data.sync.ProviderSyncWorker
import com.exacomtv.data.sync.XtreamIndexWorker
import com.exacomtv.player.timeshift.TimeshiftDiskManager
import javax.inject.Inject

@HiltAndroidApp
class ExacomTVApp : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        val gcWorkRequest = PeriodicWorkRequestBuilder<com.exacomtv.data.sync.SyncWorker>(24, java.util.concurrent.TimeUnit.HOURS)

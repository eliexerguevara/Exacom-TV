...
@AndroidEntryPoint
class ExacomTVTvInputService : TvInputService() {
    ...
    override fun onCreateSession(inputId: String): Session = ExacomTVSession(this)

    private inner class ExacomTVSession(context: Context) : Session(context) {
    ...
    private companion object {
        const val TAG = "ExacomTVTvInput"
        const val DEFAULT_USER_AGENT = "ExacomTVTvInput"

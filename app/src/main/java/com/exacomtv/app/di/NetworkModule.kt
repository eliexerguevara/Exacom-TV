...
import com.exacomtv.data.remote.http.DefaultUserAgentInterceptor
import com.exacomtv.data.remote.http.buildAppRequestProfile
import com.exacomtv.data.remote.http.buildAppUserAgent
import com.exacomtv.data.remote.stalker.OkHttpStalkerApiService
...
import com.exacomtv.player.PlaybackSupportSnapshotStore
...
object NetworkModule {
    ...
    fun provideOkHttpClient(
        ...
        return OkHttpClient.Builder()
            .cache(
                Cache(
                    directory = File(context.cacheDir, "exacomtv_http_cache"),
    ...
    fun provideMainPlayerEngine(
        ...
        playbackCompatibilityRepository: com.exacomtv.domain.repository.PlaybackCompatibilityRepository,

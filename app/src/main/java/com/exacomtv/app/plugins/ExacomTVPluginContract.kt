...
object ExacomTVPluginContract {
    const val API_VERSION = 1

    const val ACTION_PLUGIN_SERVICE = "com.exacomtv.plugin.API"
    const val META_MANIFEST_JSON = "com.exacomtv.plugin.MANIFEST_JSON"
    const val META_ID = "com.exacomtv.plugin.ID"
    const val META_NAME = "com.exacomtv.plugin.NAME"
    const val META_VERSION_NAME = "com.exacomtv.plugin.VERSION_NAME"
    const val META_VERSION_CODE = "com.exacomtv.plugin.VERSION_CODE"
    const val META_DESCRIPTION = "com.exacomtv.plugin.DESCRIPTION"
    const val META_CAPABILITIES = "com.exacomtv.plugin.CAPABILITIES"
    const val META_CONFIGURATION_MODE = "com.exacomtv.plugin.CONFIGURATION_MODE"
    const val META_CONFIGURATION_ACTIVITY_ACTION = "com.exacomtv.plugin.CONFIGURATION_ACTIVITY_ACTION"
    const val META_PROVIDER_NAME = "com.exacomtv.plugin.PROVIDER_NAME"

...
@Serializable
data class ExacomTVPluginManifest(
    ...
    val supportsConfigurationActivity: Boolean
        get() = hasCapability(ExacomTVPluginContract.CAPABILITY_CONFIGURATION_ACTIVITY) &&
            !configurationActivityAction.isNullOrBlank()

    val usesActivityConfiguration: Boolean
        get() = configurationMode == ExacomTVPluginContract.CONFIGURATION_MODE_ACTIVITY

    val supportsHostRenderedConfiguration: Boolean
        get() = configurationMode == ExacomTVPluginContract.CONFIGURATION_MODE_HOST_SCHEMA ||
            (configurationMode != ExacomTVPluginContract.CONFIGURATION_MODE_ACTIVITY &&
                hasCapability(ExacomTVPluginContract.CAPABILITY_CONFIGURATION_SCHEMA))

    val canConfigure: Boolean
        get() = supportsHostRenderedConfiguration || supportsConfigurationActivity
}

data class InstalledExacomTVPlugin(
    val packageName: String,
    val serviceClassName: String,
    val appLabel: String,
    val manifest: ExacomTVPluginManifest,
    val enabled: Boolean,

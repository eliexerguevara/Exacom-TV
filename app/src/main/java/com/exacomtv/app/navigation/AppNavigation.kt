package com.exacomtv.app.navigation
...
import com.exacomtv.app.ui.screens.dashboard.DashboardScreen
import com.exacomtv.app.ui.screens.multiview.MultiViewScreen
import com.exacomtv.app.ui.screens.home.HomeScreen
            ...
            DashboardScreen(
                ...
                onRecentChannelClick = { channel, combinedProfileId ->
                    navController.navigateToPlayer(
                        Routes.livePlayer(
                            channel = channel,
                            categoryId = com.exacomtv.domain.model.VirtualCategoryIds.RECENT,
                ...
                onFavoriteChannelClick = { channel, combinedProfileId ->
                    navController.navigateToPlayer(
                        Routes.livePlayer(
                            channel = channel,
                            categoryId = com.exacomtv.domain.model.VirtualCategoryIds.FAVORITES,
                            providerId = channel.providerId,
                            isVirtual = true,
                            combinedProfileId = combinedProfileId,
                            returnRoute = Routes.HOME
                ...
                onPlaybackHistoryClick = { history ->
                    val route = when (history.contentType) {
                        com.exacomtv.domain.model.ContentType.LIVE -> {
                            Routes.player(
                        ...
                        com.exacomtv.domain.model.ContentType.MOVIE -> {
                            Routes.player(
                                streamUrl = history.streamUrl,
                                title = history.title,
                                internalId = history.contentId,
                        ...
                        com.exacomtv.domain.model.ContentType.SERIES -> {
                            Routes.seriesDetail(history.contentId, Routes.HOME)
                        }
                        com.exacomtv.domain.model.ContentType.SERIES_EPISODE -> {
                            Routes.player(
                                streamUrl = history.streamUrl,
                                title = history.title,
                                internalId = history.contentId,
...
// ... (rest of file)
        ...
        composable(
            ...
            com.exacomtv.app.ui.screens.epg.FullEpgScreen(
        ...
        composable(
            ...
            com.exacomtv.app.ui.screens.settings.parental.ParentalControlGroupScreen(
                currentRoute = Routes.SETTINGS,
                onNavigate = { route -> tabNavigate(route) },
                onBack = { navController.popBackStack() }
            )
        ...
        composable(
            ...
            com.exacomtv.app.ui.screens.search.SearchScreen(
        ...
        composable(
            ...
            com.exacomtv.app.ui.screens.movies.MovieDetailScreen(
                onPlay = { movie ->
                    navController.navigateToPlayer(
        ...
        composable(
            ...
            com.exacomtv.app.ui.screens.series.SeriesDetailScreen(

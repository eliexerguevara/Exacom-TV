package com.exacomtv.app.ui.screens.series
...
import com.exacomtv.app.ui.components.SavedCategoryContextCard
import com.exacomtv.app.ui.components.SavedCategoryShortcut
import com.exacomtv.app.ui.components.SavedCategoryShortcutsRow
import com.exacomtv.app.ui.components.SelectionChip
import com.exacomtv.app.ui.components.SelectionChipRow
...
import com.exacomtv.domain.model.LibraryFilterType
import com.exacomtv.domain.model.LibrarySortBy
...
import com.exacomtv.app.ui.components.ReorderTopBar
import com.exacomtv.app.ui.components.dialogs.DeleteGroupDialog
import com.exacomtv.app.ui.components.dialogs.RenameGroupDialog
import com.exacomtv.app.ui.components.shell.BrowseHeroPanel
import com.exacomtv.app.ui.components.shell.BrowseSearchLaunchCard
import com.exacomtv.app.ui.components.shell.LoadMoreCard
import com.exacomtv.app.ui.components.shell.InfiniteScrollEffect
import com.exacomtv.app.ui.components.shell.AppNavigationChrome
import com.exacomtv.app.ui.components.shell.AppMessageState
import com.exacomtv.app.ui.components.shell.AppScreenScaffold
import com.exacomtv.app.ui.components.shell.VodActionChip
import com.exacomtv.app.ui.components.shell.VodActionChipRow
import com.exacomtv.app.ui.components.shell.VodCategoryOption
import com.exacomtv.app.ui.components.shell.VodCategoryPickerDialog
import com.exacomtv.app.ui.components.shell.VodBrowseOptionsDialog
import com.exacomtv.app.ui.components.shell.VodClassicCategoryOption
import com.exacomtv.app.ui.components.shell.VodClassicContentHeader
import com.exacomtv.app.ui.components.shell.VodClassicSplitLayout
import com.exacomtv.app.ui.components.shell.VodHeroStrip
import com.exacomtv.app.ui.components.shell.VodSectionHeader
import com.exacomtv.app.ui.design.FocusRestoreHost
import com.exacomtv.app.ui.design.requestFocusSafely
import com.exacomtv.app.ui.model.VodViewMode
import com.exacomtv.app.ui.screens.vod.HandleVodUserMessage
import com.exacomtv.app.ui.screens.vod.ProtectedVodPinDialog
import com.exacomtv.app.ui.screens.vod.VodBrowseDefaults
import com.exacomtv.app.ui.screens.vod.vodActiveFilterSortDetail
...
fun SeriesScreen(
    ...
    if (uiState.showDialog && uiState.selectedSeriesForDialog != null) {
        ...
        com.exacomtv.app.ui.components.dialogs.AddToGroupDialog(
    ...
    if (uiState.selectedCategoryForOptions != null) {
        ...
        com.exacomtv.app.ui.components.dialogs.CategoryOptionsDialog(
            category = category,
        ...
        buildMap<String, Category> {
            ...
            put(
                ...
                Category(
                    ...
                    type = com.exacomtv.domain.model.ContentType.SERIES,
                    isVirtual = true
                )
            )
        }

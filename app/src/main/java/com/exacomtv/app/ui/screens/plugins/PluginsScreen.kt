package com.exacomtv.app.ui.screens.plugins
...
import com.exacomtv.app.plugins.InstalledExacomTVPlugin
import com.exacomtv.app.plugins.PluginConfigurationAction
import com.exacomtv.app.plugins.PluginConfigurationField
import com.exacomtv.app.plugins.PluginConfigurationSection
            ...
            if (configuration != null) {
                ...
                LazyColumn(
                    ...
                    if (uiState.plugins.isEmpty() && !uiState.isLoading) {
                        item {
                            Text(
                                text = "No compatible ExacomTV plugins are installed.",
...
private fun PluginInstallPanel(
    ...
    Column(
        ...
        Text(
            text = "Manual installs are detected when this screen refreshes. Compatible plugins expose the ExacomTV plugin service.",
            style = MaterialTheme.typography.bodySmall,
...
private fun PluginInstallUrlDialog(
    ...
    PremiumDialog(
        ...
        subtitle = "Enter the direct APK URL. ExacomTV will download it and open the installer.",
        onDismissRequest = {
            keyboardController?.hide()

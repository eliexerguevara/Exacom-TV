...
import com.exacomtv.app.device.rememberIsTelevisionDevice
import com.exacomtv.app.ui.theme.*
import com.exacomtv.app.player.external.ExternalPlayerLaunchResult
import com.exacomtv.app.player.external.ExternalPlayerLauncher
...
import com.exacomtv.player.PLAYER_TRACK_AUTO_ID
...
import com.exacomtv.player.PlayerTrack
import com.exacomtv.player.TrackType
...
import com.exacomtv.app.ui.components.dialogs.ProgramHistoryDialog
...
import com.exacomtv.app.ui.components.PlayerRenderView
import com.exacomtv.app.ui.design.requestFocusSafely
import com.exacomtv.app.ui.notifications.rememberNotificationPermissionGate
import com.exacomtv.app.ui.screens.player.overlay.ChannelInfoOverlay
import com.exacomtv.app.ui.screens.player.overlay.ChannelVariantSelectionDialog
import com.exacomtv.app.ui.screens.player.overlay.CategoryListOverlay
import com.exacomtv.app.ui.screens.player.overlay.ChannelListOverlay
import com.exacomtv.app.ui.screens.player.overlay.DiagnosticsOverlay
import com.exacomtv.app.ui.screens.player.overlay.EpgOverlay
import com.exacomtv.app.ui.screens.player.overlay.PlayerErrorOverlay
import com.exacomtv.app.ui.screens.player.overlay.PlayerNoticeBanner
import com.exacomtv.app.ui.screens.player.overlay.PlayerEpisodeSelectionDialog
import com.exacomtv.app.ui.screens.player.overlay.PlayerResumePrompt
import com.exacomtv.app.ui.screens.player.overlay.PlayerTrackSelectionDialog
import com.exacomtv.app.ui.screens.player.overlay.PlayerAspectRatioToast
import com.exacomtv.app.ui.screens.player.overlay.PlayerControlsOverlay
import com.exacomtv.app.ui.screens.player.overlay.PlayerNumericInputOverlay
import com.exacomtv.app.ui.screens.player.overlay.PlayerResolutionBadge
import com.exacomtv.app.ui.screens.player.overlay.PlayerAudioVideoOffsetDialog
import com.exacomtv.app.ui.screens.player.overlay.PlayerSpeedSelectionDialog
import com.exacomtv.app.ui.screens.player.overlay.PlayerSleepTimerDialog
import com.exacomtv.app.ui.screens.player.overlay.PlayerSleepTimerWarningOverlay
import com.exacomtv.app.ui.screens.player.overlay.PlayerTransparentGuideOverlay
import com.exacomtv.app.ui.screens.player.overlay.StreamFormatSelectionDialog
import com.exacomtv.app.ui.screens.player.overlay.NextEpisodeCountdownOverlay
import com.exacomtv.app.ui.screens.multiview.MultiViewViewModel
import com.exacomtv.app.ui.screens.multiview.MultiViewPlannerDialog
import com.exacomtv.app.navigation.Routes
import com.exacomtv.app.ui.remote.PlayerRemoteShortcutHandler
import com.exacomtv.app.ui.remote.dispatchPlayerRemoteShortcut
import com.exacomtv.app.ui.remote.remoteColorButtonForKeyCode
...
fun PlayerScreen(
    ...
    Box(
        ...
        if (currentChannelRecording?.status == com.exacomtv.domain.model.RecordingStatus.RECORDING) {
        ...
        if (!isInPictureInPictureMode && showFullGuideOverlay && contentType == "LIVE") {
            val guideViewModel: com.exacomtv.app.ui.screens.epg.EpgViewModel = hiltViewModel()
...
private fun PlayerControlsOverlayHost(
    ...
    currentRecordingStatus: com.exacomtv.domain.model.RecordingStatus?,
    isMuted: Boolean,
    playbackSpeed: Float,
    mediaTitle: String?,
    sleepTimerUiState: SleepTimerUiState,

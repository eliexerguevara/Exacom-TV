...
import com.exacomtv.app.diagnostics.CrashReportStore
...
import com.exacomtv.app.update.AppUpdateDownloadState
import com.exacomtv.app.update.AppUpdateDownloadStatus
import com.exacomtv.app.update.AppUpdateInstaller
import com.exacomtv.app.update.GitHubReleaseChecker
import com.exacomtv.app.update.GitHubReleaseInfo
...
import com.exacomtv.data.sync.SyncRepairSection
...
import com.exacomtv.domain.manager.DriveBackupSyncManager
...
import com.exacomtv.domain.model.RecordingStorageConfig
...
import com.exacomtv.domain.model.RemoteShortcutSelection
...
import com.exacomtv.domain.usecase.ExportBackup
import com.exacomtv.domain.usecase.ExportBackupCommand
import com.exacomtv.domain.usecase.ExportBackupResult
import com.exacomtv.domain.usecase.ImportBackup
import com.exacomtv.domain.usecase.ImportBackupCommand
import com.exacomtv.domain.usecase.ImportBackupResult
import com.exacomtv.domain.usecase.InspectBackupCommand
import com.exacomtv.domain.usecase.InspectBackupResult
...
import com.exacomtv.domain.usecase.SyncProvider
import com.exacomtv.domain.usecase.SyncProviderCommand
import com.exacomtv.domain.usecase.SyncProviderResult
import com.exacomtv.player.AudioCompatibilityMemoryStore
...
class SettingsViewModel @Inject constructor(
    ...
    private val playbackHistoryRepository: com.exacomtv.domain.repository.PlaybackHistoryRepository,
    ...
    private val epgSourceRepository: com.exacomtv.domain.repository.EpgSourceRepository,
    ...
    private fun com.exacomtv.app.diagnostics.CrashReportSummary.toUiModel(): CrashReportUiModel =
        CrashReportUiModel(
            timestamp = timestamp,
            exception = exception,
            fileName = fileName,
    ...
    fun setPlayerSurfaceMode(mode: com.exacomtv.domain.model.PlayerSurfaceMode) {
        viewModelScope.launch {

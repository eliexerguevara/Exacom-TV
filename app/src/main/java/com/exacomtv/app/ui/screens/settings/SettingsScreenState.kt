...
import com.exacomtv.app.util.OfficialBuildStatus
...
private fun formatExternalPlaybackModeLabel(
    mode: com.exacomtv.domain.model.ExternalPlaybackMode,
    context: Context
): String = when (mode) {
    com.exacomtv.domain.model.ExternalPlaybackMode.INTERNAL_PLAYER -> context.getString(R.string.settings_external_playback_mode_internal)
    com.exacomtv.domain.model.ExternalPlaybackMode.ASK_EVERY_TIME -> context.getString(R.string.settings_external_playback_mode_external)
    com.exacomtv.domain.model.ExternalPlaybackMode.EXTERNAL_PLAYER -> context.getString(R.string.settings_external_playback_mode_external)
}

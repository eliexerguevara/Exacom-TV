    ...
    viewModelScope.launch {
        withScopedScrubbingMode(playerEngine::setScrubbingMode) {
            ...
            playerEngine.playbackState
                .filter {
                    it == com.exacomtv.player.PlaybackState.READY ||
...
internal fun PlayerViewModel.recordLivePlayback(channel: com.exacomtv.domain.model.Channel) {
...
internal fun PlayerViewModel.resolveChannelByNumber(number: Int?): com.exacomtv.domain.model.Channel? {
    if (number == null) return null
    return channelNumberIndex[number]
}

internal fun PlayerViewModel.resolveChannelByPrefix(prefix: String): com.exacomtv.domain.model.Channel? {
...
internal fun PlayerViewModel.resolveChannelNumber(
    channel: com.exacomtv.domain.model.Channel,
    index: Int

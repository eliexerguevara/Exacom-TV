 ...
 * The [formatUrl] is one of the [com.exacomtv.domain.model.ChannelQualityOption.url] values
 * from the channel's [com.exacomtv.domain.model.Channel.qualityOptions].
 */
